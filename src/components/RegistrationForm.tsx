  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast({
          title: "Error",
          description: text.includes("exists") ? "Email already exists" : "Registration failed",
          variant: "destructive",
        });
      }
    } catch {
    ...
    <div className="w-full max-w-md mx-auto px-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          ...
          <a href="/" className="text-foreground font-semibold underline hover:text-accent transition-colors">
            Login here.
          </a>
          <br />
